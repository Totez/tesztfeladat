...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _create_project__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./create_project */ "./resources/js/create_project.js");
...
/***/ "./resources/js/create_project.js":
/*!****************************************!*\
  !*** ./resources/js/create_project.js ***!
  \****************************************/
/***/ (() => {
...
document.addEventListener("DOMContentLoaded", function () {
  document.querySelector('.list-group').addEventListener('click', function (event) {
    if (event.target && event.target.classList.contains('list-group-item')) {
      ...
      fetch("/project/".concat(projectId)).then(function (response) {
        return response.json();
      }).then(function (data) {
        if (data.error) {
          console.error(data.error);
        } else {
          (0,_state__WEBPACK_IMPORTED_MODULE_0__.setCurrentProjectId)(data.id);
          ...
          if (data.dates[0]) {
            ...
            if (!data.dates[0].finish) {
              (0,_state__WEBPACK_IMPORTED_MODULE_0__.startTimer)();
            }
          } else {
            (0,_state__WEBPACK_IMPORTED_MODULE_0__.setTimer)();
          }
        }
...
document.addEventListener("DOMContentLoaded", function () {
  document.body.addEventListener('click', function (event) {
    ...
    if (event.target && event.target === _state__WEBPACK_IMPORTED_MODULE_0__.startButton) {
      var currentProjectId = (0,_state__WEBPACK_IMPORTED_MODULE_0__.getCurrentProjectId)();
      if (!(0,_state__WEBPACK_IMPORTED_MODULE_0__.getIsRunning)()) {
        fetch("/project-date/".concat(currentProjectId), {
          method: 'POST',
          headers: {
          ...
          memo.value = "";
          (0,_state__WEBPACK_IMPORTED_MODULE_0__.startTimer)();
          (0,_state__WEBPACK_IMPORTED_MODULE_0__.setIsRunning)(true);
          (0,_state__WEBPACK_IMPORTED_MODULE_0__.setCurrentProjectDateId)(data.id);
        })["catch"](function (error) {
          console.error('Error:', error);
        });
      }
    }
    if (event.target && event.target === _state__WEBPACK_IMPORTED_MODULE_0__.stopButton) {
...
/* harmony export */   currentProjectDateId: () => (/* binding */ currentProjectDateId),
/* harmony export */   currentProjectId: () => (/* binding */ currentProjectId),
/* harmony export */   getCurrentProjectDateId: () => (/* binding */ getCurrentProjectDateId),
/* harmony export */   getCurrentProjectId: () => (/* binding */ getCurrentProjectId),
/* harmony export */   getIsRunning: () => (/* binding */ getIsRunning),
/* harmony export */   getStartButton: () => (/* binding */ getStartButton),
/* harmony export */   getStopButton: () => (/* binding */ getStopButton),
...
/* harmony export */   setCurrentProjectDateId: () => (/* binding */ setCurrentProjectDateId),
/* harmony export */   setCurrentProjectId: () => (/* binding */ setCurrentProjectId),
/* harmony export */   setIsRunning: () => (/* binding */ setIsRunning),
/* harmony export */   setStartButton: () => (/* binding */ setStartButton),
/* harmony export */   setStopButton: () => (/* binding */ setStopButton),
...
function setCurrentProjectDateId(id) {
  return currentProjectDateId = id;
}
function getCurrentProjectDateId(id) {
...
function setStopButton(bool) {
  stopButton.disabled = bool;
}
function getStopButton() {
  return stopButton;
}
function setStartButton(bool) {
